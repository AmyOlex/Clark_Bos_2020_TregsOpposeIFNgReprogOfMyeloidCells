...
datadir = "../data/"
TCGA_data_All = "SupFigure9a_DATA_TCGA-BRCA_Expression_92-Gene_Signature_allEXP_log2TPMUpperQuantNorm.txt"

## Print out LOW gene sug for Sup Fig 9b
biomarker_exp <- read.delim(file=paste0(datadir,TCGA_data_All), sep=" ")
...
png(filename=paste("SuppFigure9a_Heatmap_TCGA-BRCA_Expression_92-Gene_Signature_AllEXP_log2TPMUpperQuantNorm.png", sep=""), width = 2000, height=1000, res=200)
...
write.table(biomarker_exp_t, file="SuppFigure9a_DATA_TCGA-BRCA_Expression_92-Gene_Signature_AllEXP_log2TPMUpperQuantNorm.txt", sep="\t", quote=FALSE)
